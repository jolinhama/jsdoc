...
var containers = ['class', 'module', 'external', 'namespace', 'mixin', 'interface', 'directive', 'service', 'provider', 'factory', 'filter', 'component', 'controller'];
...
exports.getMembers = function(data) {
    var members = {
        ...
        directives: find( data, {kind: 'directive'} ),
        services: find( data, {kind: 'service'} ),
        providers: find( data, {kind: 'provider'} ),
        factories: find( data, {kind: 'factory'} ),
        filters: find( data, {kind: 'filter'} ),
        components: find( data, {kind: 'component'} ),
        controllers: find( data, {kind: 'controller'} )
    };
...
exports.getAncestorLinks = function(data, doclet, cssClass) {
    var orgAncestors = exports.getAncestors(data, doclet);

    var ancestors = [];
    if (orgAncestors != null && orgAncestors.length > 0) {
        ancestors[0] = orgAncestors[orgAncestors.length - 1];
    }
